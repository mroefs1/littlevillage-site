...
## Standing conventions (carried forward from Steps 1-29)
...
5. **Verify behaviour with real interaction, scoped correctly.** An unscoped `document.querySelector('.nav-dropdown-menu')` grabs the first of four dropdowns and falsely reports the one you're testing as broken.
...
- **Seven placeholder boxes still render** pending photos: 4 on Admissions' journey, 1 each on About, Contact and Support Us. All have a document and field waiting - each is one upload, no deploy.
