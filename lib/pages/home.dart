...
class Home extends StatelessComponent {
  ...
  static List<StyleRule> get styles => [
    css('.home', [
      ...
      css('.home-news-date').styles(margin: .only(top: 5.px), color: AppColors.muted, fontSize: 12.px),
      css('.home-event-row', [
        css('&').styles(
          display: .flex,
          minHeight: 100.px,
      ...
      css('.home-event-date').styles(minWidth: 56.px, flex: Flex(grow: 0, shrink: 0), textAlign: .center),
